...
model=torch.load("./resnet50_cam.pth")
#
# model=torch.load("model/mobileV3_all.pth")
...
def getHot(img):
	...
	color_cam ,visualization= show_cam_on_image(rgb_img, grayscale_cam)  # (224, 224, 3)

	return grayscale_cam,color_cam,visualization
